...
FIRESIM_SOURCE_DIRS = $(addprefix $(FIRESIM_DIR)/,sim/firesim-lib sim/midas/targetutils) $(addprefix $(base_dir)/generators/firechip/,core bridge-interfaces)
CHIPYARD_SOURCE_DIRS = $(filter-out $(base_dir)/generators/firechip,$(wildcard $(addprefix $(base_dir)/,generators/* $(FIRESIM_SOURCE_DIRS) fpga/fpga-shells fpga/src tools/stage tools/stage-chisel3)))
