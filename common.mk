...
FIRESIM_SOURCE_DIRS = $(addprefix $(FIRESIM_DIR)/,sim/firesim-lib sim/midas/targetutils)
CHIPYARD_SOURCE_DIRS = $(addprefix $(base_dir)/,generators $(FIRESIM_SOURCE_DIRS) fpga/fpga-shells fpga/src tools/stage tools/stage-chisel3)
