...
# TODO: AJG: cleaner should expose a function to do this from firesim
...
symlink_firesim_files:
	...
	mkdir -p $(FIRESIM_SYMLINK_DIR)/bridge-interfaces
	ln -sf $(chipyard_dir)/generators/firechip/bridge-interfaces/src \
		$(FIRESIM_SYMLINK_DIR)/bridge-interfaces/.
	mkdir -p $(FIRESIM_SYMLINK_DIR)/firesim-only
	ln -sf $(chipyard_dir)/generators/firechip/firesim-only/src \
		$(FIRESIM_SYMLINK_DIR)/firesim-only/.
